...
CREATE TABLE `xxl_job_registry` (
  ...
  `registry_key` varchar(255) NOT NULL COMMENT '执行器Key',
  `registry_value` varchar(255) NOT NULL COMMENT '执行器Value',
...
CREATE TABLE `xxl_job_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `i_trigger_time` (`trigger_next_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- 初始化执行器组（根据你的应用名称）
-- ============================================
INSERT INTO `xxl_job_group` (`appname`, `title`, `address_type`, `address_list`, `update_time`) VALUES
('yulu-ticket-service', 'YuLu工单服务', 0, NULL, NOW());

-- ============================================
-- 初始化完成
-- ============================================
SELECT 'XXL-Job 数据库初始化完成！' AS message;
